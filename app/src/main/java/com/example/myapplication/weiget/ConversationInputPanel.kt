...
public class ConversationInputPanel  @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : FrameLayout(context, attrs,
    ...
    private val flEmoticonLayout: FrameLayout by lazy { inputPanelView!!.findViewById<FrameLayout>(R.id.fl_chat_detail_emoticon) }
    private val functionExtFrameLayout by lazy { inputPanelView!!.findViewById<FrameLayout>(R.id.fl_chat_detail_ext) }
    ...
    */
    fun init(activity:AppCompatActivity,rootInputAwareLayout: InputAwareLayout){
        ...
        flEmoticonLayout.setOnClickListener(this)
        functionExtFrameLayout.setOnClickListener(this)
    }

    override fun onClick(v: View) {
        when(v.id){
            R.id.fl_chat_detail_emoticon->{//按钮1
